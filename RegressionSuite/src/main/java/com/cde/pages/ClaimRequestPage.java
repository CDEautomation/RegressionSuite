...
public class ClaimRequestPage extends WebUtils{
	...
	@FindBy(linkText="Claim Requests")
	WebElement claimreq;
	...
	// This method is used to hover to Requests tab
		...
		public String validateClaimśRequestPage() {
		...
		public void clickonDRP() throws Exception {
			...
			WebUtils.clickEventByUsingJavascriptExe(driver, wait, claimreq);
		
		}
		
		// This method is used to click on add DocketRequest 
		public void clickonAddCRP() throws Exception {
